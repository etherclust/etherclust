...
class TestAirdropSentBack(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # airdropped tokens are sent back to the distributor (not wanted)
        g.addAggregation(recipientsAggregated, '0xdistributor', airdropAmount)
